<header class="text-center bg-dark py-3">
  ...
  <nav class="nav justify-content-center">
    <a class="nav-link text-light mx-2 rounded-2 {{ Route::currentRouteName() === 'home' || Route::currentRouteName() === 'sortByVote' || Route::currentRouteName() === 'sortByTitle' ? 'active' : '' }}" href="{{ route('home') }}">Home</a>
